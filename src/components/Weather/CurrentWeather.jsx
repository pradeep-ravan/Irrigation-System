...
const CurrentWeather = () => {
  const { weather, loading } = useIrrigation();
  
  if (loading || !weather) return <div className="loading">Loading weather data...</div>;
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center">
            ...
            <div>
              <div className="text-3xl font-bold text-gray-800">{weather.current.temp}°F</div>
          ...
          <div className="text-right">
            ...
            <div className="text-gray-600">Wind: {weather.current.wind} mph</div>
            <div className="text-gray-600">Chance of Rain: {weather.current.rain_chance}%</div>
          </div>
        </div>
